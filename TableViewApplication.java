...
public class TableViewApplicationResult extends Application {
  ...
  TableColumn custNetSalaryCol = new TableColumn("Net Salary");
        ...
        final Button deleteButton = new Button("Delete Record");
        ...
        hb.getChildren().addAll(addCustID, addCustFName, addCustLName, addCustAddress, addCustStatus, addCustChkAcct, addCustNetSalary, addCustDownPayment, addCustMonthlyPay, addButton, printButton, deleteButton);
        hb.setSpacing(3);
